...
<!-- WORKING NOTE / STUB: thinking in progress, not finished. Grew out of "Bus factor of one" and "OSPO solo maintainers." Backed by the consolidation note reference/notes/ai-and-the-stewardship-gap. -->

The reflex I keep hearing is that AI writes the code now, so universities need less of the software support they were never quite funding anyway. If a model can generate the pipeline, why staff an OSPO or an RSE team to help with it? The evidence I've been collecting this month points the other way. AI increases how much code gets produced faster than it increases anything durable, and that widens the gap a stewardship function exists to close.
